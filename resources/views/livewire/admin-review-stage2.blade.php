<div>
    ...
    <div class="flex flex-1 flex-col gap-3">
        <div class="rounded shadow-lg bg-white border-2 border-gray-200 mx-2 my-4 p-2 pb-4">
            ...
            <div class="mx-3 mb-2 px-2 font-bold text-gray-600">Reviewed</div>
            <div class="font-bla mx-3 mb-2 px-2 text-gray-600">This Application's automatic socre has been
                reviewed. Pending manual scoring</div>
